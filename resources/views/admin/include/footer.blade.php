...
<!--		File-Uploads Js
        ...
        <script src="../assets_admin/plugins/fancyuploder/jquery.fileupload.js"></script>
        <script src="../assets_admin/plugins/fancyuploder/jquery.iframe-transport.js"></script>
        <script src="../assets_admin/plugins/fancyuploder/jquery.fancy-fileupload.js"></script>
        <script src="../assets_admin/plugins/fancyuploder/fancy-uploader.js"></script>
