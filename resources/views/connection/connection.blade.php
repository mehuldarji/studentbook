            ...
            <aside class="col col-xl-3 order-xl-2 col-lg-12 order-lg-2 col-12">
                ...
                <div class="box shadow-sm mb-3 border rounded bg-white ads-box text-center">
                    <div class="image-overlap-2 pt-4">
                        <img src="{{ asset('img/l4.png')}}" class="img-fluid rounded-circle shadow-sm" alt="Responsive image">
                        <img src="{{ asset('img/user.png')}}" class="img-fluid rounded-circle shadow-sm" alt="Responsive image">
                    </div>
